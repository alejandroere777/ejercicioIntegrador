//const fetch = require('node-fetch') //EC5
...
const EVOL_URL = BASE_URL + '/evolution-chain/'
...
const getCharmander = async () => {
    const pokemon = await fetch(`${BASE_URL}/pokemon/charmander`, opts)
...
// console.log(`Habilidades: ${charmObj.abilities[0].ability.name}`);
